...
class Eljur(object):
	def __init__(self: Self, vendor: str, login: str, password: str, devkey: str = '9235e26e80ac2c509c48fe62db23642c', domain: str = 'https://api.eljur.ru/api') -> None:
	...
	def getrules(self: Self) -> Optional[Dict[str, Any]]:
		return self.call('getrules') # for example
